...
import {
  SearchItemComponent
} from '@app/components/backoffice/search/search-item/search-item.component';
import {
  SearchRoutingModule
} from '@app/components/backoffice/search/search-routing-module';
import {AsyncPipe, NgForOf, NgOptimizedImage} from '@angular/common';
import {VideoService} from '@app/service/video.service';
import {SortPipe} from '@app/pipes/sort.pipe';
import {CardComponent} from '@app/components/backoffice/search/card/card.component';
